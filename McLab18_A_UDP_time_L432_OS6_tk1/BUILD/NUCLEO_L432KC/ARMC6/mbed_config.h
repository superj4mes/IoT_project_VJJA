...
#define MBED_CONF_APP_MQTT_AUTH_TOKEN                                         "AAAAAAAAAAAAAAAAAAA"                                                                            // set by application
#define MBED_CONF_APP_MQTT_BROKER_HOSTNAME                                    "test.mosquitto.org"                                                                             // set by application
#define MBED_CONF_APP_MQTT_BROKER_PORT                                        1883                                                                                             // set by application
#define MBED_CONF_APP_MQTT_CLIENT_ID                                          "mikamikamaa"                                                                                    // set by application
#define MBED_CONF_APP_MQTT_TOPIC                                              "kekeboi"                                                                                        // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                                           "08112009Dan!"                                                                                   // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "Swordfish"                                                                                      // set by application
